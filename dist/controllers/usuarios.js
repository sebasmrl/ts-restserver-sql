...
const getUsuarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const usuarios = yield (yield usuario_1.default.findAll()).filter(user => user.get('estado') != false);
...
const putUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield usuario.update(body); //si hay campos que no hay en el modelo, son ignorados
        res.status(200).json(usuario);
    }
    catch (error) {
        console.log(error);
